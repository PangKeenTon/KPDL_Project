...
% Blue border frame - drawn as overlay
\begin{tikzpicture}[remember picture, overlay]
  ...
  \draw[line width=1pt, blue!80!black] 
...
\textbf{\Large ĐẠI HỌC PHENIKAA}\\[0.3cm]
\textbf{\Large TRƯỜNG CÔNG NGHỆ THÔNG TIN}\\[0.3cm]
\rule{8cm}{0.5pt}\\[1.5cm]

% Logo
\includegraphics[width=5cm]{logotruong.png}\\[1.2cm]

% Report title
\textbf{\Large BÁO CÁO BÀI TẬP LỚN}\\[0.4cm]
\textbf{\large HỌC PHẦN: KHAI PHÁ DỮ LIỆU}\\[0.3cm]
\textbf{(Mã HP: CSE702022-1-2-25)}\\[1.2cm]

% Topic title
\textbf{\large TÊN ĐỀ TÀI:}\\[0.4cm]
\textbf{\Large ``Phân tích và phân cụm khách hàng thẻ tín dụng''}\\[2cm]

% Student information
\begin{flushleft}
\hspace{4cm}Thông tin sinh viên: \textbf{Nguyễn Đức Mạnh - 23010902}\\[0.4cm]
\hspace{4cm}Giảng viên hướng dẫn: \textbf{TS. Trịnh Thành}
\end{flushleft}
...
\input{chapters/chapter4_data_preprocessing}
\input{chapters/chapter5_eda}
\input{chapters/chapter6_clustering_analysis}
\input{chapters/chapter7_business_insights}
